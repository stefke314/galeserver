...
public class UserEntityCache extends ForwardingCache<UserEntity> {
	public UserEntityCache(CacheResolver<UserEntity> resolver) {
		super(Caches.newCache(50, resolver, UserEntity.nullValue));
	}
}
