...
public class UMCacheResolver extends EventBusCacheResolver<EntityValue> {
	public UMCacheResolver() {
		super(EntityValue.class);
	}
	...
	protected List<String> putEvents(List<String> events) {
		try {
			return getEventBusClient().event("setum", events);
		} catch (Exception e) {
			throw new IllegalArgumentException(
