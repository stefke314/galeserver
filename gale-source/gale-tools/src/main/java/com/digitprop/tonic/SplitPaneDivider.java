...
class SplitPaneDivider extends BasicSplitPaneDivider {
	...
	protected void oneTouchExpandableChanged() {
		...
		if (ui.getSplitPane() != null
				&& ui.getSplitPane().isOneTouchExpandable())
			...
			public void paint(Graphics g) {
				...
				if (splitPane != null) {
					...
					Color colors[] = { this.getBackground(),
							...
							TonicLookAndFeel.getPrimaryControlInfo(),
							TonicLookAndFeel.getPrimaryControlHighlight() };
