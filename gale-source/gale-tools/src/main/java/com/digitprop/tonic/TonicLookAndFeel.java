...
/**
 * Represents the Tonic Look and Feel, and provides the UIManager with the
 * settings for Tonic.
 * 
 * @version 1.0.5
 * 
...
public class TonicLookAndFeel extends MetalLookAndFeel {
	...
	private static final ColorUIResource textFg = new ColorUIResource(
			Color.BLACK);

	/** The window background color */
	private static final ColorUIResource windowBg = new ColorUIResource(220,
			220, 220);

	/** The background for inactive windows */
	private static final ColorUIResource inactiveBg = new ColorUIResource(180,
			180, 180);

	/** The background for active windows */
	private static final ColorUIResource activeBg = new ColorUIResource(220,
			220, 220);

	/** The highlight for active resources */
	private static final ColorUIResource activeHighlight = new ColorUIResource(
			Color.WHITE);

	/** The shadow for active resources */
	private static final ColorUIResource activeShadow = new ColorUIResource(
			150, 150, 150);

	/** The light shadow for active resources */
	private static final ColorUIResource activeLightShadow = new ColorUIResource(
			200, 200, 200);

	/** The foreground color for selections */
	private static final ColorUIResource selFg = new ColorUIResource(
			Color.WHITE);
	...
	private static final ColorUIResource toolButtonActiveBg = new ColorUIResource(
			173, 173, 209);
	...
	private static final ColorUIResource focusColor = selBg; // focusColor=new
																// ColorUIResource(100,
																// 90, 130);

	/** The color of inactive borders */
	private static final ColorUIResource inactiveBorderColor = new ColorUIResource(
			100, 90, 90);

	/** The border of components */
	private static final ColorUIResource borderColor = new ColorUIResource(100,
			90, 90);

	/** The background for fields */
	private static final ColorUIResource fieldBg = new ColorUIResource(
			Color.WHITE);

	/** The color for tree lines */
	private static final ColorUIResource treeLineColor = new ColorUIResource(
			220, 220, 220);

	/** Inactive window gradient color 1 */
	private static final ColorUIResource inactiveGradColor1 = new ColorUIResource(
			200, 200, 200);

	/** Inactive window gradient color 2 */
	private static final ColorUIResource inactiveGradColor2 = new ColorUIResource(
			Color.WHITE);
	...
	private static final ColorUIResource activeGradColor2 = new ColorUIResource(
			Color.WHITE);

	/** Background for tool tips */
	private static final ColorUIResource toolTipBg = new ColorUIResource(255,
			255, 240);

	/** Standard font */
	private static FontUIResource stdFont = new FontUIResource("Tahoma",
			Font.PLAIN, 11);

	/** Standard bold font */
	private static final FontUIResource stdBoldFont = new FontUIResource(
			"Tahoma", Font.BOLD, 11);

	/** Helper border to be used in compound border */
	private static final Border hb5 = BorderFactory
			.createLineBorder(fieldBg, 1);

	/** Helper border to be used in compound border */
	private static final Border hb6 = BorderFactory
			.createLineBorder(borderColor);

	/** Helper border to be used in compound border */
	private static final Border hb7 = BorderFactory
			.createLineBorder(borderColor);

	/** Helper border to be used in compound border */
	private static final Border hb8 = BorderFactory.createCompoundBorder(hb5,
			hb6);

	/** Helper border to be used in compound border */
	private static final BorderUIResource.CompoundBorderUIResource internalFrameBorder = new BorderUIResource.CompoundBorderUIResource(
			hb7, hb8);

	/** Helper border to be used in compound border */
	private static final BorderUIResource internalFrameBorder2 = new BorderUIResource(
			new InternalFrameBorder(borderColor, inactiveBg, Color.WHITE));

	private static final BorderUIResource.LineBorderUIResource plainDialogBorder = new BorderUIResource.LineBorderUIResource(
			Color.BLACK);

	/** Helper border to be used in compound border */
	private static final Border hb1 = BorderFactory.createMatteBorder(0, 0, 1,
			0, activeHighlight);

	/** Helper border to be used in compound border */
	private static final Border hb2 = BorderFactory.createMatteBorder(0, 0, 1,
			0, activeShadow);

	/** Border for separating the menu (and toolbars) from the main panel */
	private static final BorderUIResource.CompoundBorderUIResource menuBarBorder = new BorderUIResource.CompoundBorderUIResource(
			hb1, hb2);

	/** Helper border to be used in compound border */
	private static final Border hb9 = BorderFactory.createMatteBorder(0, 0, 0,
			1, activeHighlight);

	/** Helper border to be used in compound border */
	private static final Border hb10 = BorderFactory.createMatteBorder(0, 0, 0,
			1, activeShadow);

	/** Border for separating the menu (and toolbars) from the main panel */
	private static final BorderUIResource.CompoundBorderUIResource toolBarVerticalBorder = new BorderUIResource.CompoundBorderUIResource(
			hb9, hb10);

	private static final BorderUIResource.EmptyBorderUIResource menuBorder = new BorderUIResource.EmptyBorderUIResource(
			2, 5, 2, 5);

	/** Helper border to be used in compound border */
	private static final Border hb3 = BorderFactory.createEmptyBorder(2, 2, 2,
			2);

	/** Helper border to be used in compound border */
	private static final Border hb4 = BorderFactory
			.createLineBorder(borderColor);

	/** Border for progress bars */
	private static final BorderUIResource.CompoundBorderUIResource progressBarBorder = new BorderUIResource.CompoundBorderUIResource(
			hb4, hb3);

	/** Simple, single pixel border */
	private static final BorderUIResource.LineBorderUIResource popupMenuBorder = new BorderUIResource.LineBorderUIResource(
			focusColor);

	/** Simple, single pixel border */
	private static final BorderUIResource.LineBorderUIResource simpleBorder = new BorderUIResource.LineBorderUIResource(
			borderColor);

	/** Border for combo boxes */
	private static final BorderUIResource.LineBorderUIResource comboBoxBorder = new BorderUIResource.LineBorderUIResource(
			borderColor);

	/**
	 * Is called by the UIManager.setLookAndFeel() method and creates the look
	 * and feel specific defaults table.
	 * 
	...
	public UIDefaults getDefaults() {
		...
		result.put("RadioButtonMenuItemUI", packageName
		...
		result.put("Button.background", windowBg); // new
		...
		result.put("FileChooser.newFolderIcon",
				makeIcon(getClass(), "icons/filechooser_newfolder.gif"));
		result.put("FileChooser.upFolderIcon",
				makeIcon(getClass(), "icons/filechooser_back.gif"));
		result.put("FileChooser.homeFolderIcon",
				makeIcon(getClass(), "icons/home.gif"));
		result.put("FileChooser.detailsViewIcon",
				makeIcon(getClass(), "icons/filechooser_details.gif"));
		result.put("FileChooser.listViewIcon",
				makeIcon(getClass(), "icons/filechooser_list.gif"));
		result.put("FileChooser.folderIcon",
				makeIcon(getClass(), "icons/tree_closed.gif"));

		result.put("FormattedTextField.font", stdFont);
		result.put("FormattedTextField.border",
				new BorderUIResource.MatteBorderUIResource(1, 1, 1, 0,
						borderColor));
		result.put("FormattedTextField.selectionBackground", selBg);
		result.put("FormattedTextField.selectionForeground", selFg);

		result.put("InternalFrame.optionDialogBorder", internalFrameBorder); // new
																				// BorderUIResource.LineBorderUIResource(borderColor,
																				// 2));
		result.put("InternalFrame.paletteBorder", internalFrameBorder); // new
																		// BorderUIResource.LineBorderUIResource(borderColor,
																		// 2));
		result.put("InternalFrame.border", internalFrameBorder2); // new
																	// BorderUIResource.LineBorderUIResource(borderColor,
																	// 2));

		result.put("InternalFrame.closeIcon",
				LookAndFeel.makeIcon(getClass(), "icons/frame_close.gif"));
		result.put("InternalFrame.icon",
				LookAndFeel.makeIcon(getClass(), "icons/frame_icon.gif"));
		result.put("InternalFrame.maximizeIcon",
				LookAndFeel.makeIcon(getClass(), "icons/frame_max.gif"));
		result.put("InternalFrame.minimizeIcon",
				LookAndFeel.makeIcon(getClass(), "icons/frame_max.gif"));
		result.put("InternalFrame.iconifyIcon",
				LookAndFeel.makeIcon(getClass(), "icons/frame_min.gif"));
		result.put("InternalFrame.inactiveTitleBackground", inactiveGradColor1);
		result.put("InternalFrame.inactiveTitleGradientColor",
				inactiveGradColor2);
		...
		result.put("List.focusCellHighlightBorder",
				new BorderUIResource.LineBorderUIResource(selBg));
		...
		result.put("OptionPane.border",
				new BorderUIResource.LineBorderUIResource(windowBg, 10));
		...
		if (isSlim)
			result.put("ScrollBar.width", new Integer(14)); // activeShadow);
															// //windowBg);

		result.put("ScrollBar.background", activeBg); // activeShadow);
														// //windowBg);
		...
		result.put("ScrollPane.border",
				new BorderUIResource.LineBorderUIResource(borderColor));
		...
		result.put(
				"SplitPane.border",
				new BorderUIResource.MatteBorderUIResource(5, 5, 2, 2, windowBg));

		result.put("Spinner.border", null);

		result.put("TabbedPane.selectedTabPadInsets", new InsetsUIResource(2,
				0, 0, 0));
		...
		result.put("Table.scrollPaneBorder",
				new BorderUIResource.LineBorderUIResource(borderColor));
		...
		result.put("TableHeader.cellBorder",
				new BorderUIResource.MatteBorderUIResource(0, 0, 1, 1,
						borderColor));
		...
		result.put("ToolTip.border", new BorderUIResource.LineBorderUIResource(
				borderColor));

		result.put("Tree.expandedIcon",
				LookAndFeel.makeIcon(getClass(), "icons/tree_expanded.gif"));
		result.put("Tree.leafIcon",
				LookAndFeel.makeIcon(getClass(), "icons/tree_leaf.gif"));
		result.put("Tree.collapsedIcon",
				LookAndFeel.makeIcon(getClass(), "icons/tree_collapsed.gif"));
		result.put("Tree.closedIcon",
				LookAndFeel.makeIcon(getClass(), "icons/tree_closed.gif"));
		result.put("Tree.openIcon",
				LookAndFeel.makeIcon(getClass(), "icons/tree_open.gif"));
		...
		result.put("controlFont", new FontUIResource(new Font("Dialog",
				Font.PLAIN, 11)));
		...
		setIcon(result, "CheckBoxMenuItem.uncheckIcon",
				"icons/menucheckbox0.gif");
		setIcon(result, "CheckBoxMenuItem.checkIcon", "icons/menucheckbox1.gif");
		setIcon(result, "RadioButtonMenuItem.uncheckIcon",
				"icons/menuradiobutton0.gif");
		setIcon(result, "RadioButtonMenuItem.checkIcon",
				"icons/menuradiobutton1.gif");
		...
		setIcon(result, "RadioButton.unselectedEnabledIcon",
				"icons/radiobutton0.gif");
		setIcon(result, "RadioButton.selectedEnabledIcon",
				"icons/radiobutton1.gif");
		setIcon(result, "RadioButton.unselectedDisabledIcon",
				"icons/radiobutton0.gif");
		setIcon(result, "RadioButton.selectedDisabledIcon",
				"icons/radiobutton1.gif");
		...
		setIcon(result, "CheckBox.unselectedDisabledIcon",
				"icons/checkbox0.gif");
	 ...
	 * an icon made from the specified icon file name. The icon is created by
	 * calling makeIcon().
	 * 
	 * @param uiDefaults
	 *            The UI defaults table for which the specified icon will be
	 *            added
	 * @param key
	 *            The key under which the icon will be added
	 * @param iconFileName
	 *            The file name of the icon to be associated with the key
	 * @see #makeIcon()
	 */
	 ...
	 * 
	 * @param key
	 *            The key for the icon to be returned
	 * 
	 * @return The icon associated with the specified key, or null, if the key
	 *         was invalid.
	 */
	public static ImageIcon getTonicIcon(String key) {
		...
		if (url != null)
			...
			url = TonicLookAndFeel.class.getResource("icons/collection/" + key
					+ ".gif");
			if (url != null)
				return new ImageIcon(url);
		}
	...
	/**
	 * Returns true if this is the native look and feel of the current operating
	 * system.
	 */
	...
	/**
	 * Returns true if the underlying platform supports or allows this look and
	 * feel
	 */
	 ...
	 * an uneditable JTextField that has focus.
	 */
	...
	// * filename.
	// */
	// public static Object makeIcon(final Class baseClass, final String
	// gifFile)
	// {
