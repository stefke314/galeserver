...
class TonicBumps implements Icon {
	...
	public TonicBumps(int width, int height) {
		this(width, height, TonicLookAndFeel.getPrimaryControlHighlight(),
				TonicLookAndFeel.getPrimaryControlDarkShadow(),
				TonicLookAndFeel.getPrimaryControlShadow());
	}
	 ...
	 * @param newTopColor
	 *            The highlight color of the bumps
	 * @param newShadowColor
	 *            The shadow color of the bumps
	 * @param newBackColor
	 *            The background color of the bumps
	 */
	public TonicBumps(int width, int height, Color newTopColor,
