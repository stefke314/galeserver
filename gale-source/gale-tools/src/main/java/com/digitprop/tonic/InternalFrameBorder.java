...
public class InternalFrameBorder extends IntelligentLineBorder {
	 ...
	 * @param inactiveColor
	 *            The fill color for inactive JInternalFrames
	 * @param activeColor
	 *            The fill color for active JInternalFrames
	 */
	public InternalFrameBorder(Color borderColor, Color inactiveColor,
			Color activeColor) {
	 ...
	 * 
	 * @param c
	 *            The component for which to paint the border
	 * @param g
