...
public class GrayedIcon implements Icon {
	 ...
	 * image, and brightening the pixels in the image. Used by buttons to create
	 * an image for a disabled button.
	 * 
	 * @author Jeff Dinkins
	 * @author Tom Ball
	 * @author Jim Graham
	...
	static class IconGrayFilter extends RGBImageFilter {
		 ...
		 *            of gray, where 100 is the darkest gray, and 0 is the
		 *            lightest
		 */
		public IconGrayFilter(boolean b, int p) {
			...
			// canFilterIndexColorModel indicates whether or not it is
			// acceptable
			// to apply the color filtering of the filterRGB method to the color
			// table entries of an IndexColorModel object in lieu of pixel by
			// pixel
			// filtering.
