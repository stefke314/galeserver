...
public class MenuBarUI extends BasicMenuBarUI {
	...
	/**
	 * Returns the input map for the specified condition, for the associated
	 * menu bar.
	 * 
	 * @param condition
	 *            This must be one of the constants defined in JComponent
	 */
	public InputMap getMyInputMap(int condition) {
		if (condition == JComponent.WHEN_IN_FOCUSED_WINDOW) {
			Object[] bindings = (Object[]) UIManager
					.get("MenuBar.windowBindings");
			if (bindings != null) {
	...
	/***
	 * This PropertyChangeListener is used to adjust the default layout manger
	 * when the menuBar is given a right-to-left ComponentOrientation. This is a
	 * hack to work around the fact that the DefaultMenuLayout (BoxLayout) isn't
	 * aware of ComponentOrientation. When BoxLayout is made aware of
	 * ComponentOrientation, this listener will no longer be necessary.
	 */
	...
	private static class RightToLeftMenuLayout extends FlowLayout implements
			UIResource {
