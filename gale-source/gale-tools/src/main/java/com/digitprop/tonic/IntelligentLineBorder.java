...
/**
 * A single-pixel line border, which displays each edge only if that edge does
 * not touch the edge of the parent component. This prevents double borders for
 * nested components.
 * <p>
 * 
...
public class IntelligentLineBorder implements Border {
	 ...
	 * 
	 * @param isHidingEdges
	 *            If true, this border is hiding thos edges for which the
	 *            underlying component touches an edge of the parent component.
	 *            Otherwise, the border will paint all edges.
	 */
	 ...
	 * depend upon whether edges of the specified component touch any edges of
	...
	/**
	 * Returns true if the specified component's left edge touches the left edge
	...
	/**
	 * Returns true if the specified component's top edge touches the top edge
	 * of the parent component.
	 */
	...
	/**
	 * Returns true if the specified component's right edge touches the left
	...
	protected boolean isTouchingRightEdge(Component c) {
		...
		return c.getX() + c.getWidth() == c.getParent().getWidth()
				- c.getParent().getInsets().right;
	}

	/**
	 * Returns true if the specified component's bottom edge touches the bottom
	 * edge of the parent component.
	 */
	protected boolean isTouchingBottomEdge(Component c) {
		...
		return c.getY() + c.getHeight() == c.getParent().getHeight()
				- c.getParent().getInsets().bottom;
	}

	/**
	 * Returns the parent component for the specified component, or null if the
	 * parent component could not be found.
	 */
	 ...
	 * 
	 * @param c
	 *            The component which contains this border
	 * @param g
