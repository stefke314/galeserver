...
public class ButtonUI extends MetalButtonUI {
		...
		if (c instanceof AbstractButton) {
			...
			if (!button.getModel().isPressed() && button.isEnabled()
				...
				if (border == null || !(border instanceof ToolBarBorder)) {
					...
					g.drawLine(insets.left, insets.top, c.getWidth()
							- insets.left - insets.right, insets.top);
					g.drawLine(insets.left, insets.top, insets.left,
	...
	protected void paintButtonPressed(Graphics g, AbstractButton b) {
		...
		if (border == null || !(border instanceof ToolBarBorder)) {
			...
			g.setColor(highlightColor);
			g.drawLine(insets.left, b.getHeight() - insets.top - insets.bottom,
					b.getWidth() - insets.left - insets.right, b.getHeight()
							- insets.top - insets.bottom);
			g.drawLine(b.getWidth() - insets.left - insets.right, insets.top,
					b.getWidth() - insets.left - insets.right, b.getHeight()
							- insets.top - insets.bottom);
		}
	}
