...
public class SpinnerUI extends BasicSpinnerUI {
	...
	/**
	 * Replaces the old editor of the associated JSpinner with the specified new
	 * editor
	 */
	 ...
	 * <code>previousButton</code> is a JButton who's
	 * <code>ActionListener</code> updates it's <code>JSpinner</code> ancestors
	 * model. If a previousButton isn't needed (in a subclass) then override
	 ...
	 * updates it's <code>JSpinner</code> ancestors model. If a nextButton isn't
	...
	protected Component createNextButton() {
		...
		if (tmpButton instanceof JButton) {
			...
			result.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1,
