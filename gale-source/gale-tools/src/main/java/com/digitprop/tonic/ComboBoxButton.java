...
class ComboBoxButton extends JButton {
	private static final long serialVersionUID = 8649512348446836377L;
	...
	ComboBoxButton() {
		...
		DefaultButtonModel model = new DefaultButtonModel() {
			private static final long serialVersionUID = 568061828658119677L;
	...
	/**
	 * Creates an instance for the specified combo box, with the specified icon,
	 * cell renderer and list.
	 * 
	 * @param cb
	 *            The combo box for which to create an instance
	 * @param i
	 *            The combo box icon
	 * @param pane
	 *            The cell renderer for the combo box
	 * @param list
	 *            The underlying list for the combo box
	 */
	 ...
	 *            The underlying list for the combo box
	 */
	public ComboBoxButton(JComboBox cb, Icon i, boolean iconOnly,
	...
	public void paintComponent(Graphics g) {
		...
		if (comboIcon != null) {
			...
			comboIcon.paintIcon(this, g,
					getWidth() / 2 - iconWidth / 2 + delta, getHeight() / 2
							- iconHeight / 2 + delta);
		}
	}

	/**
	 * Convenience function for determining the component orientation. Helps us
