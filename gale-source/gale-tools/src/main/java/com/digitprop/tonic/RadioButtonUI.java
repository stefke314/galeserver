...
public class RadioButtonUI extends ToggleButtonUI {
	...
	public void installDefaults(AbstractButton b) {
		...
		if (!defaults_initialized) {
			...
			// Get icons
			selectedEnabledIcon = UIManager.getIcon(getPropertyPrefix()
					+ "selectedEnabledIcon");
			selectedDisabledIcon = UIManager.getIcon(getPropertyPrefix()
					+ "selectedDisabledIcon");
			unselectedEnabledIcon = UIManager.getIcon(getPropertyPrefix()
					+ "unselectedEnabledIcon");
			unselectedDisabledIcon = UIManager.getIcon(getPropertyPrefix()
	...
	protected void paintFocus(Graphics g, Rectangle textRect, Dimension size) {
		...
		if (focusColor != null) {
			...
			BasicGraphicsUtils.drawDashedRect(g, left, top, right - left + 1,
					bottom - top + 1);
		}
	}
