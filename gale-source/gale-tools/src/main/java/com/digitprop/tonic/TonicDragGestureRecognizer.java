 ...
 * that have a <code>dragEnabled</code> property. The gesture for a drag in this
 * package is a mouse press over a selection followed by some movement by enough
 * pixels to keep it from being treated as a click.
 * 
